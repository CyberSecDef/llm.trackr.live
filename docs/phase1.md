...
| M7 | Frontend — Static UI | M5 | 7 days | 🟡 In progress (chunks 1–5 + 6a done) | |
...
- [~] Prompt input panel (chunk 6a — preview + autosize + warning shipped; live-stream pane is chunk 6b):
